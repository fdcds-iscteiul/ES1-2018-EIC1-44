...
public class Mail {
	...
	private void getmails() throws MessagingException {
		try {
		...
		for (int i=0; i < messages.length; ++i) {
			...
			try {
				String conteudo = getTextFromMessage(msg);
				mess.add(new API_Message(msg.getFrom()[0].toString(), msg.getSubject() , conteudo));
			} catch (Exception e1) {
